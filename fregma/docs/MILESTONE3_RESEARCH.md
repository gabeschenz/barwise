# Fregma Milestone 3: JSON Schema and YAML Serialization - Research Summary
...
- [ ] LLM prompt integration (separate package: @fregma/llm)
...
```typescript
import { ProjectSerializer, MappingSerializer } from '@fregma/core';
...
### 11.3 LLM Integration (@fregma/llm)
