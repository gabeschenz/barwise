...
describe("Lineage Manifest", () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "fregma-lineage-test-"));
  });
  ...
  describe("writeManifest", () => {
    it("should create .fregma/lineage.yaml in the specified directory", () => {
      ...
      const manifestPath = path.join(tempDir, ".fregma", "lineage.yaml");
  ...
  describe("readManifest", () => {
    ...
    it("should return undefined when .fregma directory does not exist", () => {
