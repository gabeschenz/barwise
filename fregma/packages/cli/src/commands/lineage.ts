/**
 * fregma lineage <subcommand>
 *
 * Lineage tracking and staleness detection.
 */

import type { Command } from "commander";
import { checkStaleness, analyzeImpact, readManifest } from "@fregma/core";
...
export function registerLineageCommand(program: Command): void {
      ...
      try {
        ...
        if (!report.manifestFound) {
          ...
          process.stdout.write(
            "Run 'fregma export' to generate artifacts and create the manifest.\n",
          );
          return;
        }
  ...
  // fregma lineage impact <source> --element <id>
  lineage
    .command("impact")
