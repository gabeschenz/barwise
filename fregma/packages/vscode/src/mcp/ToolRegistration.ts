/**
 * Registers fregma ORM tools with VS Code's Language Model Tool API
 ...
 *
 * Each tool wraps the corresponding execute function from @fregma/mcp,
...
import type { LlmClient } from "@fregma/llm";
...
// import_transcript
//
// This tool is special: instead of delegating to the @fregma/mcp
...
/**
 * Register all fregma ORM tools with vscode.lm.registerTool().
 *
...
export function registerLanguageModelTools(
  ...
  context.subscriptions.push(
    vscode.lm.registerTool("fregma_validate_model", new ValidateModelTool()),
    vscode.lm.registerTool(
      "fregma_verbalize_model",
      new VerbalizeModelTool(),
    ),
    vscode.lm.registerTool(
      "fregma_generate_schema",
      new GenerateSchemaTool(),
    ),
    vscode.lm.registerTool("fregma_diff_models", new DiffModelsTool()),
    vscode.lm.registerTool(
      "fregma_generate_diagram",
      new GenerateDiagramTool(),
    ),
    vscode.lm.registerTool(
      "fregma_import_transcript",
      new ImportTranscriptTool(),
    ),
    vscode.lm.registerTool("fregma_merge_models", new MergeModelsTool()),
  );
}
