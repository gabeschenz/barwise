...
to try the full Fregma pipeline: import, validate, verbalize, and diagram.
...
**Anthropic (direct)** -- uses the Anthropic SDK. Set `fregma.llmProvider` to
`"anthropic"` in VS Code settings and provide your key via `fregma.anthropicApiKey`
