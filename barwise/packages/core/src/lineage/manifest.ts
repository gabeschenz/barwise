...
/**
 * Write a lineage manifest to .barwise/lineage.yaml in the specified directory.
 */
export function writeManifest(dir: string, manifest: LineageManifest): void {
  const manifestPath = path.join(dir, MANIFEST_DIR);

  // Create .barwise directory if it doesn't exist
...
/**
 * Read a lineage manifest from .barwise/lineage.yaml in the specified directory.
