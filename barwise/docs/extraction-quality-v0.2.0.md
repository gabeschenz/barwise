# Extraction Quality Assessment -- Barwise v0.2.0

Date: 2026-03-01
Barwise version: 0.2.0
...
1. **BARWISE-pcj**: Added explicit mandate in the fact types section:
...
2. **BARWISE-h9q**: Added ternary/n-ary guidance in the fact types section
   with concrete examples (scheduling rules, order-product-quantity).

3. **BARWISE-cma**: Changed data type instruction from "Include length
   for text" to "ALWAYS include length for text types" with inferred
   length guidelines (codes 10-20, names 100-200, free text 500).

4. **BARWISE-afb**: Added to reference_mode instructions: "NEVER a
